...
public final class ActivityCustomPBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityCustomPBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView18,
  ...
  @NonNull
  public static ActivityCustomPBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityCustomPBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_custom_p, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityCustomPBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCustomPBinding((ConstraintLayout) rootView, textView18, textView20,
